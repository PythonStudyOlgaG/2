...
class Cell:
    ...
    def __add__(self, other):
        return f'Было две, теперь одна. Размер клетки равен: {self.quantity + other.quantity}'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Клетка после уменьшения теперь равна: {sub} клеткам' if sub > 0 else 'Клетка погибла'
